...
def invoices_input(tmp_path: Path) -> Path:
    df = pd.DataFrame([
        ...
        {"거래처명": "B", "거래명세서번호": "INV-2", "품목": "X",
         "단가": 1100, "수량": 5, "금액": 5_500},
        {"거래처명": "C", "거래명세서번호": "INV-3", "품목": "X",
         "단가": 950, "수량": 8, "금액": 7_600},
        {"거래처명": "D", "거래명세서번호": "INV-4", "품목": "X",
         "단가": 1050, "수량": 2, "금액": 2_100},
        # 마지막 행이 outlier (5σ+)
        {"거래처명": "E", "거래명세서번호": "INV-5", "품목": "X",
         "단가": 15000, "수량": 1, "금액": 15_000},
    ])
